		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dealer Target",
									"targetURL": "#titandealtitandealerstarget-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"titandealtitandealerstarget-display": {
								"semanticObject": "titandealtitandealerstarget",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=titan.deal.titandealerstarget",
									"url": sap.ui.require.toUrl("titan/deal/titandealerstarget")
								}
							}
						}
					}
